    ...
    <div class="inputs">
        <form action="{{ route('register') }}" method="post">
            ...
            <div class="form">
                ...
                <input placeholder="Full Name" id="name" type="text" class="form-field animation a4"
                ...
                <input placeholder="Email" id="email" type="email" class="form-field animation a4"
                ...
                <input placeholder="Password" id="password" type="password" class="form-field animation a4"
                ...
                <input placeholder="Confirm password" id="password-confirm" type="password"
                    class="form-field animation a4" class="form-control" name="password_confirmation" required
                    autocomplete="new-password">


                <p class="animation a5"><a href="/login">Login</a></p>
                <br>
